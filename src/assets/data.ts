export const thisprojectslide = [
  {
    preview: "assets/img/portfolio-design-thumbnail.jpg",
    src: "assets/img/portfolio-design.jpg",
    title: "Portfolio Prototype",
    description: "",
  },
  {
    preview: "assets/img/portfoliologo-dark-thumbnail.png",
    src: "assets/img/portfoliologo-dark.jpg",
    title: "Portfolio logo - dark background",
    description: "",
  },

  {
    preview: "assets/img/portfoliologo-light-thumbnail.png",
    src: "assets/img/portfoliologo-light.jpg",
...
export const otherprojectslide = [
  {
    preview: "assets/img/anniversary-desktop-thumbnail.jpg",
    src: "assets/img/anniversary-desktop.jpg",
    title: "One Peace ltd. 20th Anniversary page",
    description: "Desktop prototype for One Peace ltd. 20th Anniversary page",
  },

  {
    preview: "assets/img/anniversary-mobile-thumbnail.jpg",
    src: "assets/img/anniversary-mobile.jpg",
    title: "One Peace ltd. 20th Anniversary page",
    description: "Mobile prototype for One Peace ltd. 20th Anniversary page",
  },
  {
    preview: "assets/img/dreamvilliage-prototype-thumbnail.jpg",
    src: "assets/img/dreamvilliage-prototype.jpg",
...
export const webslides = [
  {
    preview: "assets/img/desktop-landingpage-thumbnail.jpg",
    src: "assets/img/desktop-landingpage.jpg",
    title: "Toddlerknit Prototype Desktop Landing page",
    description: "Landing page - Desktop version.",
  },
  {
    preview: "assets/img/desktop-browse-thumbnail.jpg",
    src: "assets/img/desktop-browse.jpg",
    title: "Toddlerknit Prototype Desktop Browse",
    description: "Page for browsing items - Desktop version.",
  },
  {
    preview: "assets/img/desktop-productpage-thumbnail.jpg",
    src: "assets/img/desktop-productpage.jpg",
    title: "Toddlerknit Prototype Desktop Product Page",
    description: "Product Page - Desktop version.",
  },

  {
    preview: "assets/img/mobile-landingpage-thumbnail.jpg",
    src: "assets/img/mobile-landingpage.jpg",
    title: "Toddlerknit Prototype Mobile Landing page",
    description: "Landing page prototype - mobile version.",
  },
  {
    preview: "assets/img/mobile-productsearch-thumbnail.jpg",
    src: "assets/img/mobile-productsearch.jpg",
    title: "Toddlerknit Prototype Mobile Browse",
    description: "Page for browsing items - mobile version.",
  },
  {
    preview: "assets/img/mobile-productpage-thumbnail.jpg",
    src: "assets/img/mobile-productpage.jpg",
...
export const slides = [
  {
    preview: "assets/img/sanpo-brandimage-thumbnail.jpg",
    src: "assets/img/sanpo-brandimage.jpg",
  ...
  {
    preview: "assets/img/sanpo-bagmockup-thumbnail.jpg",
    src: "assets/img/sanpo-bagmockup.jpg",
  ...
  {
    preview: "assets/img/desktop-sanpokuschel-thumbnail.jpg",
    src: "assets/img/desktop-sanpokuschel.jpg",
  ...
  {
    preview: "assets/img/vieo-brandimage-thumbnail.jpg",
    src: "assets/img/vieo-brandimage.jpg",
  ...
  {
    preview: "assets/img/doomdawn01-thumbnail.jpg",
    src: "assets/img/doomdawn01.jpg",
  ...
  {
    preview: "assets/img/doomdawn02-thumbnail.jpg",
    src: "assets/img/doomdawn02.jpg",
  ...
  {
    preview: "assets/img/doomdawn03-thumbnail.jpg",
    src: "assets/img/doomdawn03.jpg",
  ...
  {
    preview: "assets/img/doomdawn04-thumbnail",
    src: "assets/img/doomdawn04.jpg",
  ...
  {
    preview: "assets/img/alice-poster-thumbnail.jpg",
    src: "assets/img/alice-poster.jpg",
  ...
  {
    preview: "assets/img/alice'sadventuresinwonderlandmockup-thumbnail.jpg",
    src: "assets/img/alice'sadventuresinwonderlandmockup.jpg",
    title: "Alice's Adventures in Wonderland - Poster",
    description:
  ...
  {
    preview: "assets/img/concretecafeads-thumbnail.jpg",
    src: "assets/img/concretecafeads.jpg",
  ...
  {
    preview: "assets/img/mockbookcovers-thumbnail.jpg",
    src: "assets/img/mockbookcovers.jpg",
    title: "Book Cover",
    description:
  ...
  {
    preview: "assets/img/hexhallcovers-thumbnail.jpg",
    src: "assets/img/hexhallcovers.jpg",
    title: "Book Cover",
    description:
      "One more modern and one more classical re-design of the book Hex Hall by Rachel Hawkins.",
  },
  {
    preview: "assets/img/logoex01-thumbnail.jpg",
    src: "assets/img/logoex01.jpg",
  ...
  {
    preview: "assets/img/framegirlwhitering-thumbnail.jpg",
  ...
  {
    preview: "assets/img/treeframe3-thumbnail.jpg",
